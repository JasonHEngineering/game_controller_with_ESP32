...
// -----------------------------
// CHANGE TO RECEIVER MAC ADDRESS
// -----------------------------
uint8_t peerAddress[] = {0x90, 0x70, 0x69, 0x31, 0xF1, 0xD0}; 

// -----------------------------
// CONTROLLER PACKET STRUCT
// -----------------------------
...
void dumpGamepad(ControllerPtr ctl) {
    ...
    esp_now_send(peerAddress, (uint8_t*)&txData, sizeof(txData));
